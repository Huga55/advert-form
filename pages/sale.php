<div class="window__block" data-block="sale">
	...
	<div class="advert__row advert__row_price">	
		<div class="form-group advert__input-block meter meter_price">
		    ...
		    <input type="text" class="form-control advert__input-text" id="price" name="price" data-validate="true" data-validate-type="required price" data-mask="true" data-mask-type="9999999999">
		</div>
